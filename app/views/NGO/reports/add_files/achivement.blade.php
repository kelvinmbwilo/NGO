...
Achievement1<br>
<textarea rows="2" placeholder="Achievement1" class="form-control" name="achievements1"></textarea>
<br>
Achievement2<br>
<textarea rows="2" placeholder="Achievement2"  class="form-control" name="achievements2"></textarea>
<br>
...
<script>
    $(document).ready(function(){
        ...
        $("#addachievements").click(function(){
            ...
            new_target += '<textarea name="achievement'+counter+'" rows="2" placeholder="Achievement'+counter+'"  class="form-control"></textarea><br>'
