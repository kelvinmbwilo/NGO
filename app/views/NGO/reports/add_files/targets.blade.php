...
Target1<br>
<textarea rows="2" placeholder="Target1" class="form-control target" name="target1"></textarea>
<br>
Target2<br>
<textarea rows="2" placeholder="Target2"  class="form-control target" name="target2"></textarea>
<br>
...
<script>
    $(document).ready(function(){
        ...
        $("#addtargets").click(function(){
            ...
            new_target += '<textarea name="target'+counter+'" rows="2" placeholder="Target'+counter+'"  class="form-control target"></textarea><br>'
